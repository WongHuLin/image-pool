...
正文共 21 张图片：13 张论文图、3 张教材／作者文章图、5 张本文自绘示意。原有四张论文图保持不变。本轮将 11 张自绘图替换为 12 张有出处的原图，其中 CSA/HCA 分别引用两张论文图。
...
| 图 04 | paper_transformer_multihead.png | Vaswani 等，Attention Is All You Need，Figure 2 右图 | [来源](https://arxiv.org/html/1706.03762v7#S3.F2) | 使用论文 HTML 单独提供的右侧原图 PNG |
...
正文的 31 组独立公式使用可编辑 LaTeX 数学格式，公式不是图片。
